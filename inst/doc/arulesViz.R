...
###################################################
### code chunk number 6: arulesViz.Rnw:281-282 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 8: arulesViz.Rnw:338-339
###################################################
head(quality(rules))
...
###################################################
### code chunk number 11: arulesViz.Rnw:393-394 (eval = FALSE)
###################################################
## sel <- plot(rules, measure=c("support", "lift"), shading="confidence", interactive=TRUE)


###################################################
### code chunk number 12: arulesViz.Rnw:471-473
###################################################
...
###################################################
### code chunk number 21: arulesViz.Rnw:769-770 (eval = FALSE)
###################################################
## sel <- plot(rules, method="grouped", interactive=TRUE)


###################################################
### code chunk number 22: arulesViz.Rnw:789-790
###################################################
...
###################################################
### code chunk number 27: arulesViz.Rnw:914-916
###################################################
### for sampling
set.seed(4321)
...
###################################################
### code chunk number 29: arulesViz.Rnw:953-955
###################################################
